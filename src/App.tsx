  ...
  return (
    <main>
      <SEO 
        ...
        description="Connect with top creators in Bengaluru. Swap skills like design, coding, photography, and more. The professional networking app for high-intent creatives."
      />
      <div id="swipe">
        <SwipeDemo />
      </div>
